...
public partial class QaArtRunner : Node
{
	...
	private static readonly Row[] Manifest =
	{
		...
		new() { Glob = "**/vfx/spark_b.png", W = 16, H = 16, Mode = Mode.Fail },
		new() { Glob = "**/vfx/ember.png", W = 16, H = 16, Mode = Mode.Fail },
		new() { Glob = "**/vfx/ember_b.png", W = 16, H = 16, Mode = Mode.Fail },
		new() { Glob = "**/vfx/smoke.png", W = 16, H = 16, Mode = Mode.Fail },
		new() { Glob = "**/vfx/smoke_b.png", W = 16, H = 16, Mode = Mode.Fail },
		new() { Glob = "**/vfx/ash_fall.png", W = 16, H = 16, Mode = Mode.Fail },
		new() { Glob = "**/vfx/impacts.png", W = 124, H = 16, Mode = Mode.Fail },
		new() { Glob = "**/far_bg.png", W = 720, H = 144, Mode = Mode.Fail },
		new() { Glob = "**/mid_bg.png", W = 720, H = 192, Mode = Mode.Fail },
